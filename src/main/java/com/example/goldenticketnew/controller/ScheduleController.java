...
public class ScheduleController {
    ...
    @GetMapping("/{id}")
    public ResponseEntity<ResponseBase<ScheduleDto>> getScheduleById(@PathVariable Integer id) {
        return ResponseEntity.ok(new ResponseBase<>(scheduleService.getScheduleById(id)));
    }
}